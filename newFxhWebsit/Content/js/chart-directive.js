...
angular.module('chart-directive', [])
    .directive('chartLine', function () {
        return {
            restrict: 'EA',
            replace: true,
            template: '<div id="chart-line" style="height:300px;margin:24px 0;">something wrong, hard to build Chart-Line</div>',
            scope: {
                origin: '@',
                option: '=',
    ...
    .directive('chartPie', function () {
        return {
            restrict: 'EA',
            replace: true,
            template: '<div id="chart-pie" style="height:250px;margin:24px 0;">something wrong, hard to build Chart-pie</div>',
            scope: {
                origin: '@',
                option: '=',
                chartClick: '&pieClick',
                    ...
                    if (scope.origin === 'true') {
                        ...
                        _option = {
                            ...
                            toolbox: {
                                feature: {
                                    saveAsImage: {
                                        show: false //scope.option.saveAsImage
                                    }
                                }
                            },
                            backgroundColor: scope.option.backgroundColor || '',
...
function setSize(elem) {
    $(elem).width((elem.parentElement.clientWidth) - 50);
